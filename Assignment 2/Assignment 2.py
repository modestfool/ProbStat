...
#postive_pairs = sorted(all_industry_topics.items(), key=operator.itemgetter(1), reverse= True)[:5]
#negative_pairs = sorted(all_industry_topics.items(), key=operator.itemgetter(1))[:5]
